...
def test_build_archive_path(fix_dir_downloaded: str, mock_settings_dir_download: None) -> None:
...
def test_find_archive(software: str, version: str, found: bool, mock_settings_dir_download: None):
